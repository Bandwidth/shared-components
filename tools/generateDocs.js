...
====
  ...
  fs.writeFileSync(path.resolve(__dirname, '..', 'docs', 'components', `${componentName}.md`), md);
...
try {
  fs.mkdirSync(path.resolve(__dirname, '..', 'docs', 'components'));
} catch (e) {
  console.info(e);
}
...
fs.writeFileSync(path.resolve(__dirname, '..', 'docs', 'components', 'index.md'), indexContent);
