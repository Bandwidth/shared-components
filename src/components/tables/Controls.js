    ...
    return (
      <ControlsRow>
        ...
        <Buttons>
          {
            enableAdd ?
              <Link onClick={onAdd} type="icon"><Icon size="21px" name="plusMath" /></Link> :
              null
          }
          {
            enableSearch ?
              <Link onClick={onSearch} type="icon"><Icon size="21px" name="plusMath" /></Link> :
              null
          }
          {
            enableDelete ?
              <Link onClick={onDelete} type="icon"><Icon size="21px" name="trash" /></Link> :
              null
          }
        </Buttons>
      </ControlsRow>
