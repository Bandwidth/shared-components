...
interface Link extends React.SFC<LinkProps> {
  styles?: any;
  Positive?: Link;
  Negative?: Link;
  Dark?: Link;
 ...
 * @component
 */
const Link: Link = linkExtensions(styles.TextLink);
Link.styles = styles;

Link.Positive = linkExtensions((styles.TextLink as any).Positive);
Link.Negative = linkExtensions((styles.TextLink as any).Negative);
Link.Dark = linkExtensions((styles.TextLink as any).Dark);
Link.Inverted = linkExtensions((styles.TextLink as any).Inverted);
