    ...
    var f = {
      ...
      m = (function(e) {
        function Editor() {
          ...
          return (e.handleChange = s()(e.handleChange.bind(e), g)), e;
        }
        return (
  ...
  1231: function(e, t, n) {
    !(function(t, n) {
      ...
      function isWordCharBasic(e) {
        return (
          /\w/.test(e) ||
          (e > '' && (e.toUpperCase() != e.toLowerCase() || F.test(e)))
        );
      }
      ...
      function isExtendingChar(e) {
        return e.charCodeAt(0) >= 768 && I.test(e);
      }
      ...
      function stretchSpansOverChange(e, t) {
        ...
        if (l)
          for (var d = 0; d < l.length; ++d) {
            var p = l[d];
            if (null == p.to) {
              var h = getMarkedSpanFor(s, p.marker);
        ...
        if (!c) {
          ...
          if (y > 0 && l)
            for (var b = 0; b < l.length; ++b)
              null == l[b].to &&
                (v || (v = [])).push(new MarkedSpan(l[b].marker, null, null));
      ...
      function getBidiPartAt(e, t, n) {
        ...
        for (var i = 0; i < e.length; ++i) {
          ...
          o.to == t && (o.from != o.to && 'before' == n ? (r = i) : (z = i)),
            o.from == t &&
              (o.from != o.to && 'before' != n ? (r = i) : (z = i));
        }
        return null != r ? r : z;
      }
          ...
          if (o) {
            ...
            if (l.level > 0) {
              ...
              (a = findFirst(
                ...
                'before' == s && (a = moveCharLogically(n, a, 1));
            } else a = i < 0 ? l.to : l.from;
            return new Pos(r, a, s);
          }
        }
        return new Pos(
          r,
        ...
        var l,
          ...
          c = function(n) {
            return e.options.lineWrapping
              ? ((l = l || prepareMeasureForLine(e, t)),
                wrappedLineExtentChar(e, t, l, n))
      ...
      function getHandlers(e, t) {
        return (e._handlers && e._handlers[t]) || G;
      }
      function off(e, t, n) {
      ...
      function highlightLine(e, t, n, r) {
        ...
        for (var a = n.state, l = 0; l < e.state.overlays.length; ++l)
          !(function(r) {
      ...
      function getContextBefore(e, t, n) {
        ...
        var o = findStartLine(e, t, n),
          ...
          l = a ? ee.fromSaved(r, a, o) : new ee(r, startState(r.mode), o);
        return (
          r.iter(o, t, function(n) {
            processLine(e, n.text, l);
            var r = l.line;
            (n.stateAfter =
      ...
      function takeToken(e, t, n, r) {
        var i,
          ...
          a = e.doc,
          l = a.mode,
          s = getLine(a, (t = clipPos(a, t)).line),
          c = getContextBefore(e, t.line, n),
          u = new Q(s.text, e.options.tabSize, c);
        for (r && (o = []); (r || u.pos < t.ch) && !u.eol(); )
          (u.start = u.pos),
            (i = readToken(l, u, c.state)),
          ...
          if (
            (d.pos > e.options.maxHighlightLength
              ? ((l = !1),
                ...
                (d.pos = t.length),
                (s = null))
              : (s = extractLineClasses(readToken(n, d, r.state, p), o)),
            p)
          ) {
            var h = p[0].name;
            h && (s = 'm-' + (s ? h + ' ' + s : h));
      ...
      function findStartLine(e, t, n) {
        for (
          ...
          if (
            c &&
            (!n || l + (c instanceof J ? c.lookAhead : 0) <= o.modeFrontier)
          )
            return l;
          var u = countColumn(s.text, null, e.options.tabSize);
        ...
        for (var i = 0; i <= (t.rest ? t.rest.length : 0); i++) {
          ...
          (r.pos = 0),
            ...
            hasBadBidiRects(e.display.measure) &&
              (l = getOrder(o, e.doc.direction)) &&
              (r.addToken = buildTokenBadBidi(r.addToken, l)),
            (r.map = []),
            insertLineContent(
              o,
              r,
          ...
          if (d.test(t)) {
            ...
            for (var h = 0; ; ) {
              ...
              if (g) {
                ...
                a && l < 9 ? c.appendChild(elt('span', [m])) : c.appendChild(m),
      ...
      function insertLineContent(e, t, n) {
        ...
        if (r)
          for (
            var a, l, s, c, u, d, p, h = i.length, f = 0, g = 1, m = '', v = 0;
            ;
      ...
      function signalLater(e, t) {
        ...
        if (n.length) {
          ...
          ae
            ...
            : le ? (r = le) : ((r = le = []), setTimeout(fireOrphanDelayed, 0));
            ...
            if (
              (i =
                a && l < 9 && 0 == c && u == o.coverEnd - o.coverStart
                  ...
                  : getUsefulRect(w(s, c, u).getClientRects(), r)).left ||
              i.right ||
              0 == c
            )
              break;
      ...
      function cursorCoords(e, t, n, r, i, o) {
        ...
        var c = getBidiPartAt(a, l, s),
          u = z,
          d = getBidi(l, c, 'before' == s);
      ...
      function coordsCharInner(e, t, n, r, i) {
        ...
        var o,
          a = 0,
          l = t.text.length,
          s = prepareMeasureForLine(e, t);
        if (getOrder(t, e.doc.direction)) {
          if (e.options.lineWrapping) {
            var c;
            (a = (c = wrappedLineExtent(e, t, s, i)).begin), (l = c.end);
          }
          o = new Pos(n, Math.floor(a + (l - a) / 2));
          var u,
            d,
          ...
          e: do {
            ...
            if (((f = cursorCoords(e, o, 'line', t, s).left - r), g > 1)) {
        ...
        var C = cursorCoords(e, o, 'line', t, s);
        return (
          (i < C.top || C.bottom < i) && (o.outside = !0),
          (o.xRel = r < C.left ? -1 : r > C.right ? 1 : 0),
          o
        );
      }
          ...
          if (!1 !== t || a != n.sel.primIndex) {
            ...
            if (
              ...
              (s || e.options.showCursorWhenSelecting) &&
                drawSelectionCursor(e, l.head, i),
                s || drawSelectionRange(e, l, o);
            }
          }
        return r;
      }
          ...
          h &&
            (f.top < g.top - 2
              ? (add(f.right, f.top, null, f.bottom),
                add(l, g.top, g.left, g.bottom))
              : add(f.right, f.top, g.left - f.right, f.bottom)),
            f.bottom < g.top && add(l, f.bottom, null, g.top);
        }
        n.appendChild(o);
      }
      ...
      function regChange(e, t, n, r) {
        ...
        if (
          ...
          R && visualLineNo(e.doc, t) < i.viewTo && resetView(e);
        else if (n <= i.viewFrom)
          R && visualLineEndNo(e.doc, n + r) > i.viewFrom
            ? resetView(e)
      ...
      function viewCuttingPoint(e, t, n, r) {
        var i,
          o = findViewIndex(e, t),
          a = e.display.view;
        if (!R || n == e.doc.first + e.doc.size) return { index: o, lineN: n };
      ...
      function updateDisplayIfNeeded(e, t) {
        ...
        n.viewFrom < o &&
          ...
          R && ((o = visualLineNo(e.doc, o)), (a = visualLineEndNo(e.doc, a)));
        var l =
          o != n.viewFrom ||
          a != n.viewTo ||
      ...
      function onScrollWheel(e, t) {
        ...
        if ((i && c) || (o && u)) {
          if (o && y && s)
            e: for (var p = t.target, h = a.view; p != l; p = p.parentNode)
          ...
          if (i && !n && !d && null != ge)
            return (
              o && u && updateScrollTop(e, Math.max(0, l.scrollTop + o * ge)),
              setScrollLeft(e, Math.max(0, l.scrollLeft + i * ge)),
      ...
      function normalizeSelection(e, t) {
        ...
        for (var r = 1; r < e.length; r++) {
          ...
          if (cmp(o.to(), i.from()) >= 0) {
            ...
            r <= t && --t, e.splice(--r, 2, new ve(s ? l : a, s ? a : l));
          }
        }
        return new me(e, t);
      }
      ...
      function updateDoc(e, t, n, r) {
        ...
        if (t.full)
          ...
          if (1 == a.length)
            ...
            h.push(new ne(c + l.text.slice(o.ch), u, r)),
              update(l, l.text.slice(0, i.ch) + a[0], spansFor(0)),
              e.insert(i.line + 1, h);
          }
        else if (1 == a.length)
          update(
          ...
          update(l, l.text.slice(0, i.ch) + a[0], spansFor(0)),
            update(s, c + s.text.slice(o.ch), u);
      ...
      function setDirectionClass(e) {
        ('rtl' == e.doc.direction
          ? addClass
          : k)(e.display.lineDiv, 'CodeMirror-rtl');
      }
      ...
      function addChangeToHistory(e, t, n, r) {
        ...
        if (
          ...
          var s = lst(i.done);
          for (
            (s && s.ranges) || pushSelectionToHistory(e.sel, i.done),
              o = {
      ...
      function skipAtomicInSelection(e, t, n, r) {
        for (var i, o = 0; o < t.ranges.length; o++) {
          ...
          (i || s != a.anchor || c != a.head) &&
            (i || (i = t.ranges.slice(0, o)), (i[o] = new ve(s, c)));
        }
              ...
              var p = (function(n) {
                ...
                linkedDocs(e, function(e, t) {
                  t ||
                    ...
                    (rebaseHist(e.history, i), l.push(e.history)),
      ...
      function makeChangeSingleDocInEditor(e, t, n) {
        var r = e.doc,
          ...
          s = o.line;
        e.options.lineWrapping ||
          ((s = lineNo(visualLine(getLine(r, o.line)))),
        ...
        for (var i = 0; i < e.length; ++i) {
          ...
          if (o.ranges) {
            ...
            for (var l = 0; l < o.ranges.length; l++)
              rebaseHistSelSingle(o.ranges[l].anchor, t, n, r),
        ...
        if (
          (e.iter(s, n.line + 1, function(e) {
            c &&
              ...
              (l = !0),
              o.collapsed && s != t.line && updateLineHeight(e, 0),
              addMarkedSpan(
                e,
                new MarkedSpan(
                  o,
          ...
          o.clearOnEnter &&
            U(o, 'beforeCursorEnter', function() {
              return o.clear();
            }),
          o.readOnly &&
            (seeReadOnlySpans(),
      ...
      function clickRepeat(e, t) {
        var n = +new Date();
        return Fe && Fe.compare(n, e, t)
          ? ((Ee = Fe = null), 'triple')
          : Ee && Ee.compare(n, e, t)
            ? ((Fe = new We(n, e, t)), (Ee = null), 'double')
            : ((Ee = new We(n, e, t)), (Fe = null), 'single');
      }
              ...
              (r && handleMappedButton(t, i, r, o, e)) ||
                (1 == i
                  ...
                  : 2 == i
                    ...
                    : 3 == i && (L ? onContextMenu(t, e) : delayBlurEvent(t)));
          }
      }
      ...
      function leftButtonDown(e, t, n, r) {
        ...
        'single' == n &&
        (i = l.contains(t)) > -1 &&
        (cmp((i = l.ranges[i]).from(), t) < 0 || t.xRel > 0) &&
      ...
      function leftButtonStartDrag(e, t, n, r) {
        ...
        s && (i.scroller.draggable = !0),
          ...
          U(document, 'mouseup', c),
          U(document, 'mousemove', u),
      ...
      function leftButtonSelect(e, t, n, r) {
          ...
          if (0 != cmp(d, t))
            if (((d = t), 'rectangle' == r.unit)) {
              ...
              i.length || i.push(new ve(n, n)),
                setSelection(
                  o,
                  normalizeSelection(s.ranges.slice(0, l).concat(i), l),
              ...
              var b,
                ...
                w = C.anchor;
              cmp(x.anchor, w) > 0
                ? ((b = x.head), (w = minPos(C.from(), x.anchor)))
                : ((b = x.anchor), (w = maxPos(C.to(), x.head)));
              var S = s.ranges.slice(0);
              (S[l] = new ve(clipPos(o, w), b)),
                setSelection(o, normalizeSelection(S, l), H);
            }
        }
        function extend(t) {
          var n = ++h,
          ...
          if (a)
            if (0 != cmp(a, d)) {
              ...
              s &&
                setTimeout(
                  operation(e, function() {
                    h == n && ((i.scroller.scrollTop += s), extend(t));
                  }),
                  50,
                );
            }
        ...
        if (
          (r.addNew && !r.extend
            ? ((l = o.sel.contains(n)), (a = l > -1 ? c[l] : new ve(n, n)))
        ...
        r.addNew
          ? -1 == l
            ? ((l = c.length),
              setSelection(o, normalizeSelection(c.concat([a]), l), {
                scroll: !1,
                origin: '*mouse',
              }))
            : c.length > 1 && c[l].empty() && 'char' == r.unit && !r.extend
              ? (setSelection(
                  o,
                  normalizeSelection(c.slice(0, l).concat(c.slice(l + 1)), 0),
                  { scroll: !1, origin: '*mouse' },
                ),
                (s = o.sel))
              : replaceOneSelection(o, l, a, H)
          : ((l = 0), setSelection(o, new me([a], 0), H), (s = o.sel));
        var d = n,
        ...
        (e.state.selectingText = g),
          U(document, 'mousemove', f),
          U(document, 'mouseup', g);
      }
      function gutterEvent(e, t, n, r) {
        ...
        for (var s = 0; s < e.options.gutters.length; ++s) {
          ...
          if (c && c.getBoundingClientRect().right >= i)
            return (
              signal(e, n, e, lineAtHeight(e.doc, o), e.options.gutters[s], t),
      ...
      function CodeMirror$1(e, t) {
        ...
        (o.wrapper.CodeMirror = this),
          ...
          (t.autofocus && !v) || this.hasFocus()
            ...
            : onBlur(this);
        for (var c in Re) Re.hasOwnProperty(c) && Re[c](n, t[c], Ie);
        maybeUpdateLineNumberWidth(this), t.finishInit && t.finishInit(this);
        for (var u = 0; u < ze.length; ++u) ze[u](n);
        endOperation(this),
          s &&
            t.lineWrapping &&
      ...
      function registerEventHandlers(e) {
        ...
        var t = e.display;
        U(t.scroller, 'mousedown', operation(e, onMouseDown)),
          a && l < 11
            ? U(
                t.scroller,
                'dblclick',
        ...
        U(t.scroller, 'touchstart', function(i) {
          ...
          U(t.scroller, 'touchcancel', finishTouch),
        ...
        U(i, 'keyup', function(t) {
          return onKeyUp.call(e, t);
        }),
          U(i, 'keydown', operation(e, onKeyDown)),
          U(i, 'keypress', operation(e, onKeyPress)),
          U(i, 'focus', function(t) {
            return onFocus(e, t);
          }),
          U(i, 'blur', function(t) {
            return onBlur(e, t);
      ...
      function domTextBetween(e, t, n, r, i) {
        ...
        for (var o = '', a = !1, l = e.doc.lineSeparator(); walk(t), t != n; )
          t = t.nextSibling;
        return o;
      }
      ...
      var O,
        ...
        E = [''],
        F = /[\u00df\u0587\u0590-\u05f4\u0600-\u06ff\u3040-\u309f\u30a0-\u30ff\u3400-\u4db5\u4e00-\u9fcc\uac00-\ud7af]/,
        I = /[\u0300-\u036f\u0483-\u0489\u0591-\u05bd\u05bf\u05c1\u05c2\u05c4\u05c5\u05c7\u0610-\u061a\u064b-\u065e\u0670\u06d6-\u06dc\u06de-\u06e4\u06e7\u06e8\u06ea-\u06ed\u0711\u0730-\u074a\u07a6-\u07b0\u07eb-\u07f3\u0816-\u0819\u081b-\u0823\u0825-\u0827\u0829-\u082d\u0900-\u0902\u093c\u0941-\u0948\u094d\u0951-\u0955\u0962\u0963\u0981\u09bc\u09be\u09c1-\u09c4\u09cd\u09d7\u09e2\u09e3\u0a01\u0a02\u0a3c\u0a41\u0a42\u0a47\u0a48\u0a4b-\u0a4d\u0a51\u0a70\u0a71\u0a75\u0a81\u0a82\u0abc\u0ac1-\u0ac5\u0ac7\u0ac8\u0acd\u0ae2\u0ae3\u0b01\u0b3c\u0b3e\u0b3f\u0b41-\u0b44\u0b4d\u0b56\u0b57\u0b62\u0b63\u0b82\u0bbe\u0bc0\u0bcd\u0bd7\u0c3e-\u0c40\u0c46-\u0c48\u0c4a-\u0c4d\u0c55\u0c56\u0c62\u0c63\u0cbc\u0cbf\u0cc2\u0cc6\u0ccc\u0ccd\u0cd5\u0cd6\u0ce2\u0ce3\u0d3e\u0d41-\u0d44\u0d4d\u0d57\u0d62\u0d63\u0dca\u0dcf\u0dd2-\u0dd4\u0dd6\u0ddf\u0e31\u0e34-\u0e3a\u0e47-\u0e4e\u0eb1\u0eb4-\u0eb9\u0ebb\u0ebc\u0ec8-\u0ecd\u0f18\u0f19\u0f35\u0f37\u0f39\u0f71-\u0f7e\u0f80-\u0f84\u0f86\u0f87\u0f90-\u0f97\u0f99-\u0fbc\u0fc6\u102d-\u1030\u1032-\u1037\u1039\u103a\u103d\u103e\u1058\u1059\u105e-\u1060\u1071-\u1074\u1082\u1085\u1086\u108d\u109d\u135f\u1712-\u1714\u1732-\u1734\u1752\u1753\u1772\u1773\u17b7-\u17bd\u17c6\u17c9-\u17d3\u17dd\u180b-\u180d\u18a9\u1920-\u1922\u1927\u1928\u1932\u1939-\u193b\u1a17\u1a18\u1a56\u1a58-\u1a5e\u1a60\u1a62\u1a65-\u1a6c\u1a73-\u1a7c\u1a7f\u1b00-\u1b03\u1b34\u1b36-\u1b3a\u1b3c\u1b42\u1b6b-\u1b73\u1b80\u1b81\u1ba2-\u1ba5\u1ba8\u1ba9\u1c2c-\u1c33\u1c36\u1c37\u1cd0-\u1cd2\u1cd4-\u1ce0\u1ce2-\u1ce8\u1ced\u1dc0-\u1de6\u1dfd-\u1dff\u200c\u200d\u20d0-\u20f0\u2cef-\u2cf1\u2de0-\u2dff\u302a-\u302f\u3099\u309a\ua66f-\ua672\ua67c\ua67d\ua6f0\ua6f1\ua802\ua806\ua80b\ua825\ua826\ua8c4\ua8e0-\ua8f1\ua926-\ua92d\ua947-\ua951\ua980-\ua982\ua9b3\ua9b6-\ua9b9\ua9bc\uaa29-\uaa2e\uaa31\uaa32\uaa35\uaa36\uaa43\uaa4c\uaab0\uaab2-\uaab4\uaab7\uaab8\uaabe\uaabf\uaac1\uabe5\uabe8\uabed\udc00-\udfff\ufb1e\ufe00-\ufe0f\ufe20-\ufe26\uff9e\uff9f]/,
        B = !1,
        R = !1,
        z = null,
        V = (function() {
          ...
          return function(e, t) {
            ...
            for (var k = 0, M = l; k < s; ++k) {
              var T = c[k];
              'L' == M && '1' == T ? (c[k] = 'L') : i.test(T) && (M = T);
            }
            for (var O = 0; O < s; ++O)
              if (r.test(c[O])) {
                var P = void 0;
            ...
            for (var H, W = [], E = 0; E < s; )
              if (o.test(c[E])) {
                var F = E;
                for (++E; E < s && o.test(c[E]); ++E);
                W.push(new BidiSpan(0, F, E));
              } else {
                var I = E,
                  B = W.length;
                for (++E; E < s && 'L' != c[E]; ++E);
                for (var R = I; R < E; )
                  if (a.test(c[R])) {
                    I < R && W.splice(B, 0, new BidiSpan(1, I, R));
                    var z = R;
                    for (++R; R < E && a.test(c[R]); ++R);
                    W.splice(B, 0, new BidiSpan(2, z, R)), (I = R);
                  } else ++R;
                I < E && W.splice(B, 0, new BidiSpan(1, I, E));
              }
            return (
              1 == W[0].level &&
                (H = e.match(/^\s+/)) &&
              ...
              1 == lst(W).level &&
                (H = e.match(/\s+$/)) &&
                ((lst(W).to -= H[0].length),
                W.push(new BidiSpan(0, s - H[0].length, s))),
              'rtl' == t ? W.reverse() : W
            );
          };
        })(),
      ...
      var re,
        ...
        ae = null,
        le = null,
        se = { left: 0, right: 0, top: 0, bottom: 0 },
        ce = function(e, t, n) {
          this.cm = n;
          var r = (this.vert = elt(
              'div',
              ...
              if (e <= a) {
                if ((o.insertInner(e, t, n), o.lines && o.lines.length > 50)) {
                  for (
                    ...
                    var c = new LeafChunk(o.lines.slice(s, (s += 25)));
                    (o.height -= c.height),
      ...
      (Ce.prototype.clear = function() {
        ...
        if (!this.explicitlyCleared) {
          ...
          for (var i = null, o = null, a = 0; a < this.lines.length; ++a) {
            var l = e.lines[a],
              s = getMarkedSpanFor(l.markedSpans, e);
            t && !e.collapsed
              ? regLineChange(t, lineNo(l), 'text')
              : t &&
                (null != s.to && (o = lineNo(l)),
                null != s.from && (i = lineNo(l))),
              (l.markedSpans = removeMarkedSpan(l.markedSpans, s)),
              null == s.from &&
                e.collapsed &&
        ...
        (Ce.prototype.find = function(e, t) {
          ...
          for (var r, i, o = 0; o < this.lines.length; ++o) {
            var a = n.lines[o],
              l = getMarkedSpanFor(a.markedSpans, n);
            if (
              null != l.from &&
              ((r = Pos(t ? a : lineNo(a), l.from)), -1 == e)
            )
              return r;
      ...
      var Ee,
        ...
        Be = {},
        Re = {};
      (CodeMirror$1.defaults = Be), (CodeMirror$1.optionHandlers = Re);
      var ze = [];
      ...
      (Ge.prototype.init = function(e) {
        ...
        (Ge.prototype.pollContent = function() {
          ...
          var x = Pos(a, h),
            w = Pos(s, p.length ? lst(p).length - f : 0);
      ...
      (Ue.prototype.init = function(e) {
        ...
        e.wrapper.insertBefore(i, e.wrapper.firstChild),
          ...
          U(o, 'paste', function(e) {
            signalDOMEvent(r, e) ||
              handlePaste(e, r) ||
              ((r.state.pasteIncoming = !0), n.fastPoll());
          }),
          U(o, 'cut', prepareCopyCut),
          U(o, 'copy', prepareCopyCut),
          ...
          (e.prototype = {
            ...
            indentSelection: methodOp(function(e) {
              for (
                ...
                if (o.empty())
                  ...
                  for (var c = s; c < r; ++c) indentLine(t, c, e);
            ...
            findPosH: function(e, t, n, r) {
              ...
              for (
                ...
                l < t && !(a = findPosH(i.doc, a, o, n, r)).hitSide;
                ++l
              );
              return a;
            },
              ...
              if (
                (r.extendSelectionsBy(function(a) {
                  ...
                  return (
                    'page' == t &&
                      a == r.sel.primary() &&
                      addToScrollTop(n, charCoords(n, s, 'div').top - l.top),
                    s
                  );
                }, W),
                i.length)
      ...
      return (
        eventMixin(Se),
        (CodeMirror$1.inputStyles = { textarea: Ue, contenteditable: Ge }),
        ...
        (CodeMirror$1.fromTextArea = function fromTextArea(e, t) {
          ...
          if (
            e.form &&
            (U(e.form, 'submit', save), !t.leaveSubmitMethodAlone)
          ) {
            var i = e.form;
            r = i.submit;
            try {
              ...
              value: function componentDidMount() {
                ...
                (this.editor = o(this.ref)),
                  this.editor.on('change', function(t, n) {
                    e.props.onValueChange &&
                      e.hydrated &&
                      e.props.onValueChange(e.editor, n, e.editor.getValue());
                  }),
        ...
        function(t, n) {
          ...
          function xmlToken(n, o, a) {
            ...
            if ('{' == n.peek()) {
              ...
              var l = flatXMLIndent(a.state),
                s = a.state.context;
              if (s && n.match(/^[^>]*>\s*$/, !1)) {
                for (; s.prev && !s.startOfLine; ) s = s.prev;
                s.startOfLine
                  ? (l -= t.indentUnit)
                  : a.prev.state.lexical && (l = a.prev.state.lexical.indented);
              } else 1 == a.depth && (l += t.indentUnit);
              return (
                (o.context = new Context(e.startState(i, l), i, 0, o.context)),
                null
              );
            }
            if (1 == a.depth) {
        ...
        function objprop(e, t) {
          return 'async' == e
            ...
            : 'variable' == e || 'keyword' == m.style
              ...
              : 'number' == e || 'string' == e
                ? ((m.marked = l ? 'property' : m.style + ' property'),
                  cont(afterprop))
                : 'jsonld-keyword' == e
                  ? cont(afterprop)
                  : 'modifier' == e
              ...
              return 'vardef' == d
                ...
                : 'form' == d && '{' == l
                  ...
                  : 'form' == d
                    ? s.indented + o
                    : 'stat' == d
                      ? s.indented + (isContinuedStatement(t, r) ? a || o : 0)
